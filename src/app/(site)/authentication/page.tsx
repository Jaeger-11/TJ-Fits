...
import { GoogleAuthProvider, signInWithEmailAndPassword, createUserWithEmailAndPassword, onAuthStateChanged, updateProfile } from "firebase/auth"
        ...
        <section className="p-4 bg-white sm:p-8 md:relative md:flex md:justify-center md:items-center md:flex-1 md:p-0">
            <article className="md:w-[90%] lg:w-3/4 py-8">
                ...
                <form className="my-6">
                    ...
                    <button onClick={() => {}} className=" text-white flex items-center gap-2 font-semibold justify-center bg-green-500 p-4 w-full rounded-md my-4 hover:scale-95 transition-all">
