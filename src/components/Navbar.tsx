        ...
        <div className=' lg:w-4/5 mx-auto justify-between flex flex-row-reverse items-center lg:flex-row'>
            ...
            <section className='hidden lg:flex items-center gap-6'>
                ...
                <div className='flex-item-center gap-4'>
                    {email ?
                    <div className="flex gap-1 items-center justify-center cursor-pointer relative" onClick={() => setDetails(!details)}>
                        <div className={`${details ? ' h-max p-4 opacity-100 pointer-events-auto' : 'p-0 h-0 opacity-0 pointer-events-none'} absolute transition-all top-[150%] bg-white shadow-md min-w-[200px] test-sm flex flex-col gap-3`}>
                            <p className="capitalize">{username || email}</p>
                            <Link href='/'>Edit Profile</Link>
                            <p className='cursor-pointer text-gray-500 text-right' onClick={logout}>Log Out</p> 
                        </div>
