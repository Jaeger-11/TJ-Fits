  ...
  return (
    <section key={_id} className="lg:grid styrene400 lg:grid-cols-6 text-sm pb-4 border-b items-center">
        <div className='flex gap-4 col-span-3'>
            <div className='w-1/6 overflow-hidden aspect-square rounded-md bg-white'>
                <Image
                src={imageUrl}
                alt={name}
                width={100}
