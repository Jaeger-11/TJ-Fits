    ...
    return (
        <div className="p-4 py-8 lg:py-4 hero">
            <main className="lg:w-4/5 mx-auto flex gap-[5rem] md:gap-0 flex-col-reverse justify-between lg:flex-row">
                ...
                <section className="w-full lg:w-1/3 flex justify-end items-center relative">
                    <div className="w-3/5 absolute top-10 left-0 lg:top-16 lg:-left-[70%] lg:w-full  overflow-hidden rounded-lg bg-gray-100 shadow-lg ">
                        <Image 
