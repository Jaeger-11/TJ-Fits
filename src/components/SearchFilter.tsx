...
const SearchFilter = () => {
  ...
  return (
    <div className=" border-b-gray-500 border-b mb-2">
        ...
        <input onInput={(e:React.ChangeEvent<HTMLInputElement>) => searchProducts(e.target.value)} className="outline-0 px-2 flex-1 max-w-[90%] bg-transparent text-xs xl:text-sm xl:placeholder:text-sm styrene400 placeholder:text-xs placeholder:styrene400" placeholder="Search Products" type="text" name="search" id="search-product" />
    </label>
</div>
  )
}
